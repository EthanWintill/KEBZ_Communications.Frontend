...
import { PhonePlan } from '../types'; // Ensure PhonePlan is correctly typed in your types file
                    ...
                    <div className="card mb-3" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', height: '100%' }}>
                        ...
                        <div className="card-body" style={{ flex: '1' }}>
                            ...
                            <ul className="list-unstyled">
                                ...
                                <li style={{ fontSize: '1.1rem' }}>Data Limit: {plans[activeTab].dataLimit} GB</li>
                                <li style={{ fontSize: '1.1rem' }}>Text Limit: {plans[activeTab].textLimit} texts</li>
                            </ul>
